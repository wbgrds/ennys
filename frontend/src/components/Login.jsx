...
export default function Login({ onLogin, onNavigate }) {
  const [email, setEmail] = useState('admin@ennyslounge.de');
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '3rem auto', padding: '2rem' }}>
      ...
      <p style={{ fontSize: '0.875rem', color: colors.textOlive, marginTop: '2rem' }}>
        💡 Test-Daten: admin@ennyslounge.de / admin123
      </p>
    </div>
  );
}
